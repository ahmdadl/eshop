...
var ShowCart = /** @class */ (function (_super) {
    ...
    ShowCart.prototype.removeItem = function (inx, id) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.delete("cart/" + id).then(function (res) {
            if (!res.data || !res.data.deleted) {
...
var Super = /** @class */ (function (_super) {
    ...
    Super.prototype.changeAmountNative = function (amount, inx, price, id) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.patch("cart/" + id, {
            amount: amount,
            total: total
        }).then(function (res) {
...
var UserProfile = /** @class */ (function (_super) {
    ...
    UserProfile.prototype.deleteProduct = function (slug, id, inx) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.delete("p/" + slug).then(function (res) {
            if (res.data && res.data.deleted) {
